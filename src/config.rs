...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
            ...
            map.insert("password".to_string(), "lsm791600".to_string());
            RwLock::new(map)
        }; 
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yczm.lsmcqx.com"];
pub const RS_PUB_KEY: &str = "7KnVv1mEz6ZNR1aeKdZJQhIEWrr30pg1WHIT+dSXijY=";
